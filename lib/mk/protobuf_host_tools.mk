...
LIBPROTOBUF_LA = $(filter %.cc, $(addprefix $(PROTOBUF_DIR)/src/, $(libprotobuf_la_SOURCES)))
LIBPROTOC_LA = $(filter %.cc, $(addprefix $(PROTOBUF_DIR)/src/, $(libprotoc_la_SOURCES)))

$(PROTOBUF_PROTOC): $(PROTOBUF_DIR)
	$(MSG_BUILD)$(notdir $@)
	$(VERBOSE)mkdir -p $(dir $@)
	$(VERBOSE)g++ -DHAVE_PTHREAD=1 -DHAVE_ZLIB=1 -lpthread -lz -std=c++11 $(LIBPROTOBUF_LA) $(LIBPROTOC_LA) $(PROTOBUF_DIR)/src/google/protobuf/compiler/main.cc -I $(PROTOBUF_DIR)/src/ -o $@ -lz
